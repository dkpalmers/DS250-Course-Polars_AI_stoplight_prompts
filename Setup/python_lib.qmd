...
```python
import sys
!{sys.executable} -m pip install numpy polars scikit-learn lets-plot palmerpenguins nbformat nbclient pyyaml setuptools jupyter
```

#### Using your terminal (alternative method)

```python
pip install numpy polars scikit-learn lets-plot palmerpenguins nbformat nbclient pyyaml setuptools jupyter
```
