...
We need to download and install `this specific version` of python approved for this course. (__Python 3.13__) We do not reccomend installing Python 3.14 at this time as the libraries have not had enought time to update to the changes from 3.13 --> 3.14. 
