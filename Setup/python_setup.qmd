...
#### Install this specific version of Python 3.14
We need to download and install `this specific version` of python approved for this course. (__Python 3.14__) We can now recommend 3.14 as Lets-Plot is now compatible with it. We will be using the `python 3.14` version for this course. You can have multiple versions of python installed on your computer but we will be using `python 3.14` for this course.
