---
title: "Unit 1 Core Task 3: Creating New Columns"
date: 2025-03-31
lastmod: 2025-03-31
weight: 2
draft: false
...
::: {.callout-note}
**Canvas:** U1: Core Task 3 — Creating New Columns  
...
**Skills:** `with_columns`, derived expressions, conditionals
...
1. Let's look at a name that is special for members of the church: Brigham. __For each year__, calculate what proportion of babies named Brigham in the country were born specifically in Idaho and Utah? 
$$
\frac{Brigham_{ID+UT}}{Brigham_{Total}}
$$

Make a graph displaying the proportion over time.
