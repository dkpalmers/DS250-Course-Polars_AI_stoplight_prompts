---
title: "Unit 3 Stretch Task: Longevity and Highest Paid Positions"
date: 2025-10-27
lastmod: 2025-10-27
weight: 4
draft: false
...
::: {.callout-note}
**Canvas:** U3: Stretch Task — Longevity and Highest Paid Positions  
...
**Skills:** validation, aggregates over joined tables, ranking positions

### Question 1

Write an SQL query that pulls the tables you need into a polars dataframe using nothing more than SELECT and FROM statements. Then, use python polars to identify the top 10 players with the longest Major League Baseball careers. Include their:
