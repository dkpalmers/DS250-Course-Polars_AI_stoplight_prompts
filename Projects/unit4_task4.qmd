...
1. __Repeat the classification exercise using 3 different models or algorithms.__ Display their Permutation Importance and Classification Report. Explainn the differences between the models and which one you would recommend to the Client.  
