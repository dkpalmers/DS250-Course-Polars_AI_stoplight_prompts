...
1. For each model (your original one, and the 2 new ones for this task), display the classification report and the importance metrics to identify the most important features.  Discuss which model you would recommend to the client and why.
